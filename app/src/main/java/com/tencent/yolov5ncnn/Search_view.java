...
public class Search_view extends Activity {
    ...
    private ArrayList<WheatDomain> items=new ArrayList<>();
    private ArrayList<WheatDomain> items2=new ArrayList<>();
    ...
    private void initRecycleView() {
        ...
        items.add(new WheatDomain("wheat","黄矮病",
                ...
                "yellow"));
        items.add(new WheatDomain("wheat","锈病","锈病是由真菌中的锈菌寄生引起的一类植物病害。危害植物的叶、茎和果实。锈菌一般只引起局部侵染，受害部位可因孢子积集而产生不同颜色的小疱点或疱状、杯状、毛状物，有的还可在枝干上引起肿瘤、粗皮、丛枝、曲枝等症状，或造成落叶、焦梢、生长不良等。严重时孢子堆密集成片，植株因体内水分大量蒸发而迅速枯死。",
                "小麦隐匿柄锈菌侵染所引起的",
        ...
        items.add(new WheatDomain("wheat","枯病",
                ...
                "blight"));
        items.add(new WheatDomain("Corn","大斑病",
                ...
                "corn_leaf_blight"));
        items.add(new WheatDomain("Potato","晚疫病",
        ...
        items.add(new WheatDomain("Corn","锈病",
                ...
                "corn_rust_leaf"));
        items.add(new WheatDomain("Tomato","晚疫病",
        ...
        items.add(new WheatDomain("Tomato","煤霉病",
                ...
                "tomato_mold_leaf"));
        items.add(new WheatDomain("Potato","早疫病",
        ...
        items.add(new WheatDomain("Tomato","黄化曲叶病",
        ...
        items.add(new WheatDomain("Tomato","花叶病",
        ...
        items.add(new WheatDomain("Tomato","细菌性斑疹病",
        ...
        items.add(new WheatDomain("Corn","霉斑病",
                ...
                "corn_gray_leaf_spot"));
        items.add(new WheatDomain("Tomato","轮纹病",
        ...
        items.add(new WheatDomain("Apple Scab Leaf","褐纹病",
        ...
        items.add(new WheatDomain("Tomato","斑点病",
        ...
        items.add(new WheatDomain("Bell pepper leaf spot","叶斑病",
        ...
        items.add(new WheatDomain("Grapevine","黑腐病",
        ...
        items.add(new WheatDomain("Tomato","二斑叶螨",
        ...
        items.add(new WheatDomain("apple","褐斑病",
                ...
                "cercospora1"));
        items.add(new WheatDomain("apple","花叶病"
                ...
                "mosaic"));
        items.add(new WheatDomain("apple","斑点落叶病",
                ...
                "apple_alternaria"));
        items.add(new WheatDomain("apple","瘤蚜",
                ...
                "apple_aphid"));
        items.add(new WheatDomain("apple","桧胶锈菌",
    ...
    protected void setListener(){
        ...
        findViewById(R.id.search_btn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.i("H", "点击了一次"+"后面是："+context);
                if(TextUtils.isEmpty(context)){
                    Log.i("2", "空");
                    Toast.makeText(getApplicationContext(),"搜索内容不能为空",Toast.LENGTH_SHORT).show();
                }else {
                      for(WheatDomain item:items){
                          if (item.getDiseasetype().equals(context)) {
                              // 假设这是我们的“选择”条件
                              Log.i("3", "有一个可加入");
                              items2.add(item);
                          }
                      }
                    ((SearchAdapter)adapter1).updateData(items2);
                }
            }
        });
    }
