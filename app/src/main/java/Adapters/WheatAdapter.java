...
public class WheatAdapter extends RecyclerView.Adapter<WheatAdapter.ViewHolder> {
    ...
    public WheatAdapter(ArrayList<WheatDomain> items) {
        this.items = items;
    ...
    public WheatAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.viewholder_1,parent,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView){
            ...
            pic = itemView.findViewById(R.id.image_wheat);
        }
    }
}
